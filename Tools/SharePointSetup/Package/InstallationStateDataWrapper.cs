...
namespace CAS.SharePoint.Setup.Package
{
  ...
  public abstract class InstallationStateDataWrapper
  {
    ...
    public string SiteCollectionURL
    {
      get
      {
        return State.SiteCollectionURL.Trim().ToLower();
      }
      set
      {
        State.SiteCollectionURL = value.Trim().ToLower();
      }
    }
    /// <summary>
    ...
    {
      get { return mySolutions; }
      private set { mySolutions = value; }
    }
    #endregion
    ...
    {
      State = _state;
      mySolutions = CollectionViewSource.GetDefaultView( _state.Solutions );
      mySolutions.SortDescriptions.Add( new SortDescription( "Priority", ListSortDirection.Ascending ) );
    }
    internal void SortSolutions( ListSortDirection direction )
    {
      if ( !Solutions.CanSort )
        return;
      Solutions.SortDescriptions.Clear();
      Solutions.SortDescriptions.Add( new SortDescription( "Priority", direction ) );
    }
    #endregion
    ...
    #endregion
    private ICollectionView mySolutions;
